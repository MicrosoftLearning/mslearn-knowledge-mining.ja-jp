...
1. Azure portal のホーム ページに戻り、**[&#65291;リソースの作成]** ボタンを選択し、「*Azure AI サービス*」を検索して、次の設定で **Azure AI サービス マルチサービス アカウント** リソースを作成します。
    - **[サブスクリプション]**: *ご自身の Azure サブスクリプション*
...
15. Azure AI 検索リソースの **[概要]** ページの下半分で、**[インデクサー]** タブを表示します。ここに、新しく作成された **margies-indexer** が表示されるはずです。 数分待ち、 **[状態]** に成功が示されるまで **&orarr; [最新の情報に更新]** をクリックします。
