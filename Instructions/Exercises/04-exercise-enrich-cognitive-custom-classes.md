...
1. **[Yes, enable multi-lingual dataset]** を選択します。
1. **[次へ]** を選択します。
...
1. **[AI サービスのアタッチ]** セクションを展開し、[無料] の下にある Azure AI サービスを選択します。
...
1. Azure portal のホーム ページに移動し、**[リソース グループ]** を選択します。
